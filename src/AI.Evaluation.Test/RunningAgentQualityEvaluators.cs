...
{
    private static readonly ReportingConfiguration reportingConfigurationWithAgentQualityEvaluators =
    ...
    public async Task RunningAgentQualityEvaluators()
    {
        ...
        await using ScenarioRun scenarioRun =
            await reportingConfigurationWithAgentQualityEvaluators.CreateScenarioRunAsync(
                ScenarioName,
                additionalTags: ["Order Status"], cancellationToken: TestContext!.CancellationToken);
